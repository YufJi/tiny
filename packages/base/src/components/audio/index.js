...
/* harmony import */ const _timeToString__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./timeToString */ './src/audio/timeToString.tsx');
...
const prefixCls = 'a-audio';
const pausePic = 'https://zos.alipayobjects.com/rmsportal/ZnENqDjdATSxszOcALjL.png';
const playPic = 'https://zos.alipayobjects.com/rmsportal/GEWVXOYPgcWRvxjPWjYc.png';
const Audio = createComponent({
  ...
  loadFn: function loadFn() {
    const audioHandle = this.refs.root;
  ...
  onError: function onError(ev) {
    ...
    if (this.props.onError && errorMsg) {
      const e = this.props.$mp.getNormalizedEvent('error', {
  ...
  timeUpdate: function timeUpdate(e) {
    ...
    if (this.props.onTimeUpdate) {
      const ev = this.props.$mp.getNormalizedEvent('timeUpdate', {
        detail: {
          currentTime,
