...
const contextPrototype = CameraContext.prototype = {};
...
contextPrototype.startRecord = function cameraAction(params) {
  ...
  const _a$timeoutCallback = _a.timeoutCallback;
  const timeoutCallback = _a$timeoutCallback === undefined ? noop : _a$timeoutCallback;
  const rest = __rest(_a, ['success', 'fail', 'complete', 'timeoutCallback']);
  this.timeoutCallback = timeoutCallback;
  clearTimeout(this.cameraRecordTimer);
  this.cameraRecordTimer = setTimeout(() => {
...
['takePhoto', 'stopRecord'].forEach((action) => {
  contextPrototype[action] = function cameraAction(params) {
    const _a = params || {};
    const _a$success2 = _a.success;
    const success = _a$success2 === undefined ? noop : _a$success2;
    const _a$fail2 = _a.fail;
    const fail = _a$fail2 === undefined ? noop : _a$fail2;
    const _a$complete2 = _a.complete;
    const complete = _a$complete2 === undefined ? noop : _a$complete2;
