...
/* harmony import */ var _utils_system__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../utils/system */ "./src/utils/system.tsx");
/* harmony import */ var _framework_dev__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../framework/dev */ "./src/framework/dev.tsx");
/* harmony import */ var _shared_Location__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../shared/Location */ "./src/bridge/shared/Location.tsx");
        ...
        chooseLocation: {
            ...
            a: function a(res) {
                ...
                if (res.poiId) {
                    ...
                    if (_utils_system__WEBPACK_IMPORTED_MODULE_0__["isAndroid"]) {
                        res.address = res.snippet;
                        res.name = '';
                    } else {
