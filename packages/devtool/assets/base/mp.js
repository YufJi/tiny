...
/* harmony import */ var _common_global__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../common/global */ "./src/framework/common/global.js");
/* harmony import */ var _EventHub__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../EventHub */ "./src/framework/EventHub.js");
/* harmony import */ var _mixins_PureRenderMixin__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../mixins/PureRenderMixin */ "./src/framework/mixins/PureRenderMixin.js");
...
reset();
_EventHub__WEBPACK_IMPORTED_MODULE_7__["default"].addListener(['pageLoad', 'pageReady', 'pageUpdate'], function (e) {
  var _objectSpread2;

  e.payload = _objectSpread(_objectSpread({}, e.payload || {}), (_objectSpread2 = {}, _defineProperty(_objectSpread2, _utils_consts__WEBPACK_IMPORTED_MODULE_4__["PayloadKeyMountedComponents"], mountedComponents), _defineProperty(_objectSpread2, _utils_consts__WEBPACK_IMPORTED_MODULE_4__["PayloadKeyUnmountedComponents"], unmountedComponents), _objectSpread2));
  reset();
});
function setComponentsConfig(componentsConfig) {
  ...
  for (var is in componentsConfig) {
    if (Object.hasOwnProperty.call(componentsConfig, is)) {
      _common_global__WEBPACK_IMPORTED_MODULE_6__["default"].componentsConfig[is] = _common_global__WEBPACK_IMPORTED_MODULE_6__["default"].componentsConfig[is] || {};
      _common_global__WEBPACK_IMPORTED_MODULE_6__["default"].componentsConfig[is].user = componentsConfig[is];
    }
  }
}
var renderCache = {};
...
function getComponentConfig(is) {
  var userConfig = _common_global__WEBPACK_IMPORTED_MODULE_6__["default"].componentsConfig[is].user || {};
  return userConfig;
}
...
function getRender(is) {
  ...
  var setupConfig = _common_global__WEBPACK_IMPORTED_MODULE_6__["default"].componentsConfig[is].system;
...
/* harmony default export */ __webpack_exports__["default"] = (function (is) {
  return Object(_nerv__WEBPACK_IMPORTED_MODULE_0__["createNervClass"])({
    ...
    displayName: is,
    mixins: [_mixins_PureRenderMixin__WEBPACK_IMPORTED_MODULE_8__["default"]],
    statics: {
      is: is
    },
    getInitialState: function getInitialState() {
    ...
    componentDidMount: function componentDidMount() {
      ...
      var __page = this.props.__page;
      var info = this.recordMounted(this.diffProps(this.state || {})); // __page.fireComponentLifecycle(info, 'attached');
    ...
    componentDidUpdate: function componentDidUpdate(prevProps) {
      ...
      if (diffProps) {
        ...
        mountedComponents.push(_defineProperty({}, _utils_consts__WEBPACK_IMPORTED_MODULE_4__["ComponentKeyId"], this.id));
      }
    },
    componentWillUnmount: function componentWillUnmount() {
      var __page = this.props.__page;
      delete __page.componentInstances[this.id];
      unmountedComponents.push(this.id); // __page.fireComponentLifecycle(this.recordMounted(false, false), 'unload');
    },
    initData: function initData(params) {
      ...
      this.setState(_objectSpread(_objectSpread({}, data), Object(_utils_mapValues__WEBPACK_IMPORTED_MODULE_3__["default"])(properties, 'value')));
    },
    ...
    recordMounted: function recordMounted(diffProps) {
      ...
      var info = (_info = {}, _defineProperty(_info, _utils_consts__WEBPACK_IMPORTED_MODULE_4__["ComponentKeyId"], this.id), _defineProperty(_info, _utils_consts__WEBPACK_IMPORTED_MODULE_4__["ComponentKeyIs"], this.is), _info);
      ...
      if (diffProps) {
        ...
        info[_utils_consts__WEBPACK_IMPORTED_MODULE_4__["ComponentKeyDiffProps"]] = newProps;
      }
    ...
    diffProps: function diffProps(prevProps) {
      var _getComponentConfig2 = getComponentConfig(this.is),
          _getComponentConfig2$ = _getComponentConfig2.properties,
          properties = _getComponentConfig2$ === void 0 ? {} : _getComponentConfig2$;
      ...
      if (isUpdated) {
        ret = ret || {};
        ret[_utils_consts__WEBPACK_IMPORTED_MODULE_4__["DiffKeyUpdated"]] = updated;
      }

      if (isDeleted) {
        ret = ret || {};
        ret[_utils_consts__WEBPACK_IMPORTED_MODULE_4__["DiffKeyDeleted"]] = deleted;
      }
    ...
    normalizeProps: function normalizeProps(props) {
      ...
      if (props[_utils_consts__WEBPACK_IMPORTED_MODULE_4__["DiffKeyDeleted"]]) {
        newProps[_utils_consts__WEBPACK_IMPORTED_MODULE_4__["DiffKeyDeleted"]] = props[_utils_consts__WEBPACK_IMPORTED_MODULE_4__["DiffKeyDeleted"]];
      }

      if (props[_utils_consts__WEBPACK_IMPORTED_MODULE_4__["DiffKeyUpdated"]]) {
        newProps[_utils_consts__WEBPACK_IMPORTED_MODULE_4__["DiffKeyUpdated"]] = _objectSpread({}, props[_utils_consts__WEBPACK_IMPORTED_MODULE_4__["DiffKeyUpdated"]]);
      }
...
/* harmony import */ var _utils_isEmpty__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @/utils/isEmpty */ "./src/utils/isEmpty.js");
...
/* harmony import */ var _CustomComponent__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./CustomComponent */ "./src/framework/legacy/CustomComponent.js");
/* harmony import */ var _common_global__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../common/global */ "./src/framework/common/global.js");
/* harmony import */ var _utils_unit__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ../utils/unit */ "./src/framework/utils/unit.js");
/* harmony import */ var _Platform__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ../Platform */ "./src/framework/Platform/index.js");
function ownKeys(object, enumerableOnly) { var keys = Object.keys(object); if (Object.getOwnPropertySymbols) { var symbols = Object.getOwnPropertySymbols(object); if (enumerableOnly) symbols = symbols.filter(function (sym) { return Object.getOwnPropertyDescriptor(object, sym).enumerable; }); keys.push.apply(keys, symbols); } return keys; }
...
function getStyleSheet(pagePath) {
  ...
  var setupConfig = _common_global__WEBPACK_IMPORTED_MODULE_12__["default"].pagesConfig[pagePath].system;
...
var remReg = Object(_utils_unit__WEBPACK_IMPORTED_MODULE_13__["rpx2px"])(2) < 1 ? /\b0\.0[12]rem/g : Object(_utils_unit__WEBPACK_IMPORTED_MODULE_13__["rpx2px"])(1) < 1 ? /\b0\.01rem/g : null;
var replacer = _Platform__WEBPACK_IMPORTED_MODULE_14__["default"].browser === 'ios' ? '0.5px' : '1px';
/* harmony default export */ __webpack_exports__["default"] = (Object(_nerv__WEBPACK_IMPORTED_MODULE_0__["createNervClass"])({
  $isCustomComponent: false,
  displayName: 'PageComponent',
  mixins: [_mixins_MessageHandleMixin__WEBPACK_IMPORTED_MODULE_7__["default"], _mixins_RefMixin__WEBPACK_IMPORTED_MODULE_8__["default"]],
  getInitialState: function getInitialState() {
  ...
  UNSAFE_componentWillMount: function UNSAFE_componentWillMount() {// this.recordMounted(false, true);
  ...
  componentDidMount: function componentDidMount() {
    ...
    Object.assign(this, {
      bridge: _common_global__WEBPACK_IMPORTED_MODULE_12__["default"].bridge,
      renderSeq: 1
    });
    ...
    _EventHub__WEBPACK_IMPORTED_MODULE_10__["default"].emit('pageLoad', e);
    this.callRemote('self', 'load');
  ...
  initData: function initData(params) {
    var id = params.id,
        data = params.data,
        publicInstance = params.publicInstance;
    this.publicInstance = publicInstance;
    this.setId(id);
    this.setState(_objectSpread({}, data));
  },
  initComponentData: function initComponentData(params) {
    var componentId = params.id,
        is = params.is,
        data = params.data,
        properties = params.properties;

    if (this.componentInstances[componentId]) {
      Object(_CustomComponent__WEBPACK_IMPORTED_MODULE_11__["setComponentsConfig"])({
        is: {
          data: data,
  ...
  startRender: function startRender(remoteConfig) {
    ...
    this.publicInstance = publicInstance;
    Object(_CustomComponent__WEBPACK_IMPORTED_MODULE_11__["setComponentsConfig"])(componentsConfig);
    this.setId(id);
    var now = Date.now();
...
/* harmony import */ var _AppRegistry__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../AppRegistry */ "./src/framework/AppRegistry/index.js");
...
/* harmony import */ var _framework_index__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./framework/index */ "./src/framework/index.js");
/* harmony import */ var _xml_runtime__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./xml-runtime */ "./src/xml-runtime/index.js");
...
self.XMLRuntime = _xml_runtime__WEBPACK_IMPORTED_MODULE_4__["default"];
self.MPUI = {
...
self.MP = {
  ...
  EventHub: _framework_index__WEBPACK_IMPORTED_MODULE_3__["EventHub"],
  App: _framework_index__WEBPACK_IMPORTED_MODULE_3__["App"],
  setCurrentPageImpl: _framework_index__WEBPACK_IMPORTED_MODULE_3__["setCurrentPageImpl"],
  getCurrentPageImpl: _framework_index__WEBPACK_IMPORTED_MODULE_3__["getCurrentPageImpl"],
  getCurrentPagesImpl: _framework_index__WEBPACK_IMPORTED_MODULE_3__["getCurrentPagesImpl"],
  getApp: _framework_index__WEBPACK_IMPORTED_MODULE_3__["getApp"],
  getAppImpl: _framework_index__WEBPACK_IMPORTED_MODULE_3__["getAppImpl"],
  getCurrentPages: _framework_index__WEBPACK_IMPORTED_MODULE_3__["getCurrentPages"],
  getStartupParams: _framework_index__WEBPACK_IMPORTED_MODULE_3__["getStartupParams"],
  setStartupParams: _framework_index__WEBPACK_IMPORTED_MODULE_3__["setStartupParams"],
  Component: _framework_index__WEBPACK_IMPORTED_MODULE_3__["Component"],
  getComponentClass: _framework_index__WEBPACK_IMPORTED_MODULE_3__["getComponentClass"],
  StyleSheet: _framework_index__WEBPACK_IMPORTED_MODULE_3__["StyleSheet"],
  createComponent: _framework_index__WEBPACK_IMPORTED_MODULE_3__["createComponent"],
  Page: _framework_index__WEBPACK_IMPORTED_MODULE_3__["Page"],
  $global: _framework_index__WEBPACK_IMPORTED_MODULE_3__["$global"]
};

var __mpCosts = Date.now() - __mpStartTime;

console.log("framework: web bundle costs ".concat(__mpCosts, " ms"));
...
/* harmony import */ var _objectKeys__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./objectKeys */ "./src/utils/objectKeys.js");
/* harmony import */ var _types__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./types */ "./src/utils/types.js");


function isEmpty(o) {
  var type = Object(_types__WEBPACK_IMPORTED_MODULE_1__["getType"])(o);

  if (type === 'object') {
    return Object(_objectKeys__WEBPACK_IMPORTED_MODULE_0__["default"])(o).length === 0;
  }
