...
/* harmony default export */ __webpack_exports__["default"] = (function (is) {
  return Object(_nerv__WEBPACK_IMPORTED_MODULE_0__["createNervClass"])({
    ...
    componentDidMount: function componentDidMount() {
      ...
      var __page = this.props.__page;
      var info = this.recordMounted(this.diffProps({}));

      __page.fireComponentLifecycle(info, 'attached'); // __page.fireComponentLifecycle(info, 'ready');
...
/* harmony default export */ __webpack_exports__["default"] = (Object(_nerv__WEBPACK_IMPORTED_MODULE_0__["createNervClass"])({
  ...
  componentDidMount: function componentDidMount() {
    ...
    _EventHub__WEBPACK_IMPORTED_MODULE_10__["default"].emit('pageLoad', e); // this.callRemote('self', 'load');
  ...
  onInitDataReady: function onInitDataReady(data) {
    ...
    this.setState(_objectSpread({}, publicInstance.data || {}));
  },
  ...
  render: function render() {
    ...
    var data = this.state;
    console.log('data', data, this.customComponents, Object(_utils_isEmpty__WEBPACK_IMPORTED_MODULE_6__["default"])(data));
