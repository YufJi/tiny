...
>
<tiny-input 
className = {"add-todo-input"} placeholder = {"What needs to be done?"} bindblur = {_ctx.$$eventBinder("onBlur")} value = {(data['inputValue'])}
>
</tiny-input>
</tiny-view>
,
...
>
<AddButton 
text = {"Add Todo"} bindclickme = {_ctx.$$eventBinder("add")}
>
</AddButton>
</tiny-view>
,
