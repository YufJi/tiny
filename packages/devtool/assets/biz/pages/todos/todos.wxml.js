...
[
<tiny-view 
id = {"parent"} style = {"background: green;"} capture-bindtap = {_ctx.$$eventBinder("pct")} bindtap = {_ctx.$$eventBinder("pt")} bindtouchstart = {_ctx.$$eventBinder("pts")} bindtouchmove = {_ctx.$$eventBinder("ptm")}
>
<tiny-view 
...
(
<AddButton 
id = {"asd"} xx = {"xxx"} text = {(data['text'])} bindclick_me = {_ctx.$$eventBinder((data['fn']))}
>
</AddButton>
)
:
