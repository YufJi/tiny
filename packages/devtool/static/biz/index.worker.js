...
/******/ 	return __webpack_require__(__webpack_require__.s = "./miniRoot/.cache/index$.worker.js");
/******/ })
/************************************************************************/
/******/ ({
...
/***/ "./miniRoot/.cache/index$.worker.js":
/*!******************************************!*\
  !*** ./miniRoot/.cache/index$.worker.js ***!
  \******************************************/
/*! no static exports found */
...
function success() {
__webpack_require__(/*! ../app */ "./miniRoot/app.js");
...
Component({
  ...
  lifetimes: {
    created() {
      console.log('cutsom-text created');
    },
  },
...
Page({
  ...
  onShow() {
    ...
    wx.request({
      url: 'http://link.igame.163.com/api/content/activity/my/music/jar/list/total', //仅为示例，并非真实的接口地址
      data: {
        type: 'all'
      },
      success: ({data}) => {
